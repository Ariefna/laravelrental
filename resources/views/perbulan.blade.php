                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="mb-2 mr-2 btn btn-warning" onclick="return confirm('Yakin Ingin Mau Kirim Angsuran Ke <?= $datas->nama_siswa; ?>?')" href="<?= URL::to('/kirimangsuran'); ?>/<?= $datas->siswa_id ?>" href="#">Kirim Angsuran</a>
                                        </td>
                                    </tr>
                                <?php endforeach;
                            else : ?>
