        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <form method="POST" action="/masterlesan/ubah/">
                    ...
                    <div class="position-relative form-group"><label class="">Harga</label><input name="harga" placeholder="Masukkan Harga" type="number" class="form-control" value="{{$data[0]->biaya_les}}"></div>
